        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.praktik.update', $praktik) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nama_praktik" 
                                         ...
                                         type="text" 
                                         name="nama_praktik" 
                                         :value="old('nama_praktik', $praktik->nama_praktik)" 
                                         required />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="alamat" 
                                      name="alamat" 
                                      rows="3" 
                                      class="block mt-1 w-full border-gray-300 focus:border-red-500 focus:ring-red-500 rounded-md shadow-sm">{{ old('alamat', $praktik->alamat) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="telepon" 
                                         ...
                                         type="text" 
                                         name="telepon" 
                                         :value="old('telepon', $praktik->telepon)" />
